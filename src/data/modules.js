import { ALPHABET_CARDS } from './vocabulary.js'
import { VOCABULARY } from './vocabulary.js'
import { VNP_SENTENCES } from './sentences.js'
import { BHAGAVAD_GITA, UPANISHAD_VERSES, YOGA_SUTRAS, GRAMMAR_LESSONS, SANDHI_RULES } from './sacred.js'

export const MODULES = [
  { id: 'beginner-script',       label: 'Devanāgarī Script',   level: 'beginner',     icon:'🔤', items: ALPHABET_CARDS.length,  unlocked: true,  route:'/flashcards',        description:'Master the Devanāgarī alphabet — vowels, consonants, and conjunct letters.' },
  { id: 'beginner-vocab',        label: 'Core Vocabulary',     level: 'beginner',     icon:'📚', items: VOCABULARY.length,      unlocked: true,  route:'/flashcards',        description:'Essential Sanskrit words with meanings, genders, and parts of speech.' },
  { id: 'beginner-vnp',          label: 'Verbs & Nouns Drill', level: 'beginner',     icon:'⚡', items: VNP_SENTENCES.length,   unlocked: true,  route:'/drill',             description:'Sentence patterns with verbs, nouns, and pronouns — the core of Sanskrit grammar.' },
